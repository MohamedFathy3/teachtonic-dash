...
export const OffersPage: React.FC = () => {
  ...
  }, [debouncedSearch, user?.id, filterType, filterActive, filterFromDate, filterToDate, lang]);
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 transition-colors duration-300">
      <div className="p-6" dir={lang === 'ar' ? 'rtl' : 'ltr'}>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
          ...
          >
            <Card className="p-4 text-center bg-gradient-to-r from-orange-500/10 to-red-500/10 dark:from-orange-500/5 dark:to-red-500/5 border-0 shadow-sm">
          ...
          >
            <Card className="p-4 text-center bg-gradient-to-r from-green-500/10 to-emerald-500/10 dark:from-green-500/5 dark:to-emerald-500/5 border-0 shadow-sm">
              <Percent className="h-8 w-8 mx-auto text-green-500 mb-2" />
              <p className="text-2xl font-bold text-gray-900 dark:text-white">
                {offers.filter((o: any) => o.type === 'offer').length}
              </p>
              <p className="text-sm text-gray-600 dark:text-gray-400">{lang === 'ar' ? 'عروض الخصم' : 'Offers'}</p>
            </Card>
          </motion.div>
          ...
          >
            <Card className="p-4 text-center bg-gradient-to-r from-purple-500/10 to-pink-500/10 dark:from-purple-500/5 dark:to-pink-500/5 border-0 shadow-sm">
              <ImageIcon className="h-8 w-8 mx-auto text-purple-500 mb-2" />
              <p className="text-2xl font-bold text-gray-900 dark:text-white">
                {offers.filter((o: any) => o.type === 'banner').length}
              </p>
              <p className="text-sm text-gray-600 dark:text-gray-400">{lang === 'ar' ? 'بانرات' : 'Banners'}</p>
            </Card>
          </motion.div>
          ...
          >
            <Card className="p-4 text-center bg-gradient-to-r from-blue-500/10 to-cyan-500/10 dark:from-blue-500/5 dark:to-cyan-500/5 border-0 shadow-sm">
              <Clock className="h-8 w-8 mx-auto text-blue-500 mb-2" />
              <p className="text-2xl font-bold text-gray-900 dark:text-white">
                {offers.filter((o: any) => o.active === 1).length}
              </p>
              <p className="text-sm text-gray-600 dark:text-gray-400">{lang === 'ar' ? 'عروض نشطة' : 'Active'}</p>
            </Card>
          </motion.div>
        </div>
        ...
        <div className="flex flex-wrap justify-between items-center gap-4 mb-6">
          <div>
            <h1 className="text-3xl font-bold bg-gradient-to-r from-orange-600 to-red-600 bg-clip-text text-transparent">
              {lang === 'ar' ? 'العروض والبانرات' : 'Offers & Banners'}
            </h1>
            <p className="text-gray-600 dark:text-gray-400 mt-1">
              {lang === 'ar' ? 'إدارة عروض الخصم والبانرات الترويجية' : 'Manage discounts and promotional banners'}
            </p>
          </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                  ...
                  <div>
                    ...
                    >
                      ...
                      <option value="offer">🎁 {lang === 'ar' ? 'عرض خصم' : 'Offer'}</option>
                      <option value="banner">🖼️ {lang === 'ar' ? 'بانر' : 'Banner'}</option>
                    </select>
                  </div>
              ...
              >
                <Card className="overflow-hidden rounded-xl hover:shadow-xl transition-all duration-300 dark:bg-gray-800 cursor-pointer border border-gray-100 dark:border-gray-700">
                  ...
                  <div className="relative h-40 bg-gradient-to-r from-orange-500 to-red-500">
                    ...
                    {/* شارة الخصم */}
                    {offer.type === 'offer' && offer.offer_discount && (
                      <div className="absolute bottom-2 left-2">
                        <Badge className="bg-red-500 text-white border-none text-sm px-2 py-1">
                    ...
                    <div className="absolute bottom-2 right-2">
                      <Badge variant="outline" className="bg-black/50 text-white border-none">
                        {offer.type === 'offer' ? (
                          <><Percent size={12} className="mr-1" /> {lang === 'ar' ? 'خصم' : 'Offer'}</>
                        ) : (
                          <><ImageIcon size={12} className="mr-1" /> {lang === 'ar' ? 'بانر' : 'Banner'}</>
                        )}
                      </Badge>
                    </div>
                  ...
                  <div className="p-4">
                    ...
                    <p className="text-sm text-gray-500 dark:text-gray-400 line-clamp-2 mb-3">
                      {offer.description || (lang === 'ar' ? 'لا يوجد وصف' : 'No description')}
                    </p>
