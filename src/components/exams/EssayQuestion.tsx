...
export const EssayQuestion: React.FC<EssayQuestionProps> = ({
  ...
  return (
    ...
    >
      ...
      <div
        className="relative bg-background rounded-xl p-4 border-2 transition-all duration-300"
        style={{
      ...
      >
        ...
        >
          <Textarea
            ...
            className="resize-none rounded-xl text-base leading-relaxed transition-all duration-300"
          />
        </motion.div>
