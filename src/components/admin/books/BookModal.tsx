                ...
                <form onSubmit={handleSubmit} className="p-6 space-y-4">
                  <div>
                    ...
                    <input
                      ...
                      placeholder={lang === 'ar' ? 'مثال: كتاب الباك إند' : 'e.g., Backend Book'}
                      required
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <div className="relative">
                      <User className={`absolute right-3 top-1/2 -translate-y-1/2 ${isDarkMode ? 'text-gray-500' : 'text-gray-400'}`} size={18} />
                      <input
                        type="text"
                        value={formData.writer}
                        onChange={(e) => setFormData({ ...formData, writer: e.target.value })}
                        className={`w-full pr-10 pl-3 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 transition-colors ${
                          isDarkMode ? 'bg-gray-700 border-gray-600 text-gray-100' : 'bg-white border-gray-300 text-gray-900'
                        }`}
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div>
                      ...
                      <div className="relative">
                        <DollarSign className={`absolute right-3 top-1/2 -translate-y-1/2 ${isDarkMode ? 'text-gray-500' : 'text-gray-400'}`} size={16} />
                        <input
                          type="number"
                    ...
                    <div>
                      ...
                      <div className="relative">
                        <FileText className={`absolute right-3 top-1/2 -translate-y-1/2 ${isDarkMode ? 'text-gray-500' : 'text-gray-400'}`} size={16} />
                        <input
                          type="number"
