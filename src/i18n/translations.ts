...
lms: "Learning Management System",
    ...
    max: "Max",
    tryAdjustingFilters: "Try adjusting your filters or create a new course",
    ...
    deactivatedSuccess: "Successfully deactivated",
...
watch_count:"عدد مرات الشاهده",
    ...
    paymentCodes: "الاكواد و المحافظ  ",
    offers:"العروض",
    centerhours: "مواعيد السناتر ",
    reject: "رفض",
    lessonPdf:"للدرس ملف pdf",
    parentPhone:"هاتف ولي الامر",
    registeredDate:"تاريخ التسجيل",
    parentCode:"كود ولي الامر",
    backToStudents:"رجوع للطلاب",
    contentLink:"رابط المحتوي ",
viewLearning: "عرض تفاصيل  ",
loadingExams:"جاري تحميل الاختبارات...",
activeExams: "الاختبارات النشطة",
inactiveExams: "الاختبارات غير النشطة",
lms:"نظام اداره التعلم ",
pendingExams: "الاختبارات قيد الانتظار",
avgMarks: "متوسط الدرجات",
    ...
    max: "الحد الأقصى",
    tryAdjustingFilters: "حاول تعديل الفلاتر أو إنشاء كورس جديد",
    deactivated: "تم إلغاء تفعيل الكورس",
    ...
    avgStudentsPerCourse: "متوسط الطلاب لكل كورس",
    contentPerCourse: "المحتوى لكل كورس",
    ...
    pendingStudents: "الطلاب قيد الانتظار",
    searchStudents: "ابحث عن طلاب...",
    deletedStudents: "الطلاب المحذوفون",
    onlineStudents: "الطلاب أونلاين",
    centerStudents: "الطلاب في السنتر",
    noStudentsFound: "لم يتم العثور على طلاب.",
    noStudentsDesc: "ابدأ بإضافة طلاب جدد إلى دوراتك!",
    activeExams: "الاختبارات النشطة",
    inactiveExams: "الاختبارات غير النشطة",
    pendingExams: "الاختبارات قيد الانتظار",
    searchExams: "ابحث عن اختبارات...",
    deletedExams: "الاختبارات المحذوفة",
    avgMarks: "متوسط الدرجات",
    studentStatus: "حالة الطالب",
    courseStatus: "حالة الكورس",
    titleAr: "العنوان (عربي)",
    descriptionAr: "الوصف (عربي)",
    aboutAr: "عن الكورس (عربي)",
