...
time: "المنطقة الزمنية",
    ...
    delete_confirmation:"تاكدي المسح",
    add_teacher:"اضافه مدرس",
    AssistantInstructors:"مساعد المدرس",
    ...
    update: "تحديث الدورة",
    uploadCourseImage: "تحميل صورة الدورة",
    courseImage: "صورة الدورة",
    recommendedImageSize: "الحجم الموصى به: 800x600 بكسل",
    pleaseUploadImage: "يرجى تحميل صورة الدورة",
    ...
    manageAndCreateExams: "إدارة وإنشاء الامتحانات الخاصة بك",
    noExamsFound: "لا توجد امتحانات",
    createYourFirstExam: "أنشئ امتحانك الأول",
    totalMarks: "الدرجة الكلية",
    durationMinutes: "المدة (دقائق)",
    createAndAddQuestions: "إنشاء وإضافة أسئلة",
    backToExams: "رجوع إلى الامتحانات",
    ...
    true: "صحيح",
    false: "خطأ",
    takeExam: "أداء الامتحان",
    addQuestions: "إضافة أسئلة",
    submitExam: "تسليم الامتحان",
    examSubmitted: "تم تسليم الامتحان!",
    ...
    system: "النظام",
    questions: "الأسئلة",
    uploadExamImage: "تحميل صورة الامتحان",
    examImage: "صورة الامتحان",
    ...
    question: "السؤال",
    gradeEssayQuestion: "تقييم سؤال مقالي",
