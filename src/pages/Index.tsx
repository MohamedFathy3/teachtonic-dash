...
function LMSApp() {
  const { role, isLoading, isAuthenticated, user } =
    useApp();
  ...
  const renderPage = () => {
    ...
    if (role === "admin") {
      ...
      switch (active) {
        ...
        case "AssistantInstructors":
          return <AssistantTeachersPage />;
    ...
    if (role === "teacher") {
      switch (active) {
        ...
        case "bank-questions":
          return <InstructorBankQuestions />;
        ...
        case "redeem-requests":
          return <InstructorRedeemRequests />;

        case "semesters":
          return <SemestersPage />;

        case "center-hours":
          return <CenterHoursPage />;
